...
namespace SimpleWifi
{
	public class AccessPoint
	{
		...
		/// </summary>
		public void ConnectAsync(AuthRequest request, bool overwriteProfile = false, Action<bool, string> onConnectComplete = null, string password = null)
		{
			...
			ThreadPool.QueueUserWorkItem(new WaitCallback((o) => {
                ...
                if (onConnectComplete != null)
                    onConnectComplete(success, password);
			}));
		}
